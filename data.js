...
window.PLAN_DATA = {
  ...
  days: [
    ...
    { date:17, wd:'周一', w:2, s:'', tags:['Agent'],
      slots:[
        { time:'21:10-22:10', text:'NFC企业知识库接前端 + Agent进阶', type:'main' },
        { time:'', text:'Legs 腿+核心', type:'workout' },
      ],
      result:'', rClass:'' },
    { date:18, wd:'周二', w:2, s:'', tags:['Agent'],
      slots:[
        { time:'21:10-22:10', text:'ReAct 深入 + Plan-Execute 范式', type:'main' },
        { time:'', text:'Push 胸肩三头', type:'workout' },
      ],
      result:'', rClass:'' },
    { date:19, wd:'周三', w:2, s:'', tags:['Agent'],
      slots:[
        { time:'21:10-22:10', text:'Multi-Agent 多智能体范式', type:'main' },
        { time:'', text:'Pull 背+二头', type:'workout' },
      ],
      result:'', rClass:'' },
    { date:20, wd:'周四', w:2, s:'', tags:['Agent'],
      slots:[
        { time:'21:10-22:10', text:'Agent 框架(LangChain/CrewAI/Dify)', type:'main' },
        { time:'', text:'Legs 腿+核心', type:'workout' },
      ],
      result:'', rClass:'' },
  ...
  modules: {
    ...
    checklist: {
      ...
      items: [
        ...
        { text:'Prompt工程 + RAG：8/11起系统推进', done:false },
    ...
    footer: {
      lines: [
        ...
        '别让完美主义杀死行动力。',
        '<span style="color:var(--green);">✅ Prompt 工程完成 · 居家训练 Push/Pull/Legs 已启动 · RAG 已完成（向量库+bge语义）</span>',
